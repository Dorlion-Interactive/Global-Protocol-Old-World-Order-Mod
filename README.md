...
1. Go to the [**Releases**](https://github.com/Dorlion-Interactive/Global-Protocol-Old-World-Order-Mod/releases/latest) page and download `old-world-order-vX.X.X.zip`
2. Extract it into:
   ```
